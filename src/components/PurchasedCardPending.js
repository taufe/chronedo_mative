...
import styles from './PurchasedCardPending.module.css';

const PurchasedCardPending = ({ image, name, price, date, email, sellerName }) => {
    return (
...
export default PurchasedCardPending;