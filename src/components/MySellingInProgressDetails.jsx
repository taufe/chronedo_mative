...
export const MySellingInProgressDetails = ({ image, name, price, date, onChange }) => {
        ...
        <div className={styles.purchaseCard}>
            ...
            <div className={styles.mainContent}>
                <div className={styles.imageContainer}>
                    <Image src={image} alt={name} width={160} height={160} className={styles.watchImage} />
                </div>
                <div className={styles.watchDetails}>
                    <h3 className={styles.watchName}>{name}</h3>
                    <div className={styles.statusContainer}>
                        <Image src="/assets/Home/completed.png" alt="In-Progress" width={20} height={20} />
            ...
            <div className={styles.sellerSection}>
                <div className={styles.sellerHeader}>
                    Statistics
                    <Image src="/assets/icons/dropdown.png" alt="Dropdown" width={16} height={16} />
                </div>
            </div>
                    ...
                    <div key={index} className={styles.stepWrapper}>
                        ...
                        {index < steps.length - 1 && (
                            <div
                                ...
                                style={{ backgroundColor: index <= activeStep ? "#999" : "#999" }}
                            ></div>
                        )}
                        {/* Step Icon */}
                        <div className={`${styles.stepIcon} ${index === activeStep ? styles.activeStep : ""}`}>
                            <Image
            ...
            {/* Dynamic Section */}
            <div className={styles.pickupDetailsContainer}>
                {getStepContent()}
            </div>
