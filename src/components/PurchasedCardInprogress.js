...
const PurchasedCardInprogress = ({ image, name, price, date, email, sellerName, onSellNow, showDetails, onBack }) => {

    return (
        <div className={showDetails ? styles.fullContainerDetails : styles.fullContainer}>            {showDetails ? (
            ...
            <div className={styles.purchaseCard}>
                ...
                <button className={styles.sellButton} onClick={() => onSellNow({ image, name, price, date, email, sellerName })}>
                    Sell Now
                </button>
            </div>
        )}
