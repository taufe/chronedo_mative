...
const Product = () => {
  ...
  const [selectedPayment, setSelectedPayment] = useState("Secure Payment Service");
  const [selectedShipping, setSelectedShipping] = useState("Shipping to");
  const [selectedMembership, setSelectedMembership] = useState("Chronedo Protection Club");
  const router = useRouter();

  const { id } = router.query; 
  console.log('id in product screen',id)


  // useEffect(() => {
  //   const storedWatch = localStorage.getItem("selectedWatch");
  //   if (storedWatch) {
  //     const parsedWatch = JSON.parse(storedWatch);
  //     console.log("Watch in product screen", parsedWatch);
  //     setProductData(parsedWatch);
  //     setQuestionId(parsedWatch?.id);
  //   }
  // }, []);
    ...
    const fetchProductData = async () => {
      try {
        ...
        const response = await axios.get(
          `https://chronedo.webjerky.com/api/watches/${id}`,
          {
            headers: {
        ...
        if (watch) {
          setProductData(watch);
          setQuestionId(watch.id);
        }
      } catch (error) {
      ...
      <div className={styles?.dashboardContainer}>
        ...
        <div className={styles?.productContainer}>
          ...
          <div className={styles.imagesSection}>
            ...
            {/* <div className={styles.thumbnailsColumn}>
            {productData && (
  [productData.side1, productData.side2, productData.back, productData.wrist_shot]
    .filter(Boolean) // Filter out null/undefined
    .map((imageUrl, index) => (
      <div key={index} className={styles.thumbnail}>
        <Image
          src={imageUrl || `/assets/ProductPage/watch${index + 2}.png`}
          alt={`Thumbnail ${index + 1}`}
          layout="fill"
          objectFit="cover"
          onError={(e) => {
            e.target.onerror = null;
            e.target.src = `/assets/ProductPage/watch${index + 2}.png`;
          }}
        />
      </div>
    ))
                ...
                <div className={styles.expandedSection}>
                  ...
                  <div className={styles.membershipSection}>
                    <div className={styles.sectionHeader}>
                      <h3>Membership</h3>
                      <span className={styles.close} onClick={() => setIsMoreExpanded(false)}>CLOSE</span>
                    </div>
                    <div
                      className={styles.membershipOption}
                      onClick={() => setSelectedMembership("Chronedo Protection Club")}
                    >
                      <div className={styles.optionLeft}>
                        <div className={selectedMembership === "Chronedo Protection Club" ? styles.radioSelected : styles.radio} />
                        <div>
                  ...
                  <div className={styles.paymentSection}>
                    ...
                    <div className={styles.paymentOptions}>
                      {["Secure Payment Service", "Direct bank payment to seller", "Cash Payment"].map(
                        (option) => (
                          <div
                            key={option}
                          ...
                          >
                            <div className={styles.optionLeft}>
                              <div className={selectedPayment === option ? styles.radioSelected : styles.radio} />
                              <span>{option}</span>
                            </div>
                            <div className={styles.optionRight}>
                              <span className={styles.questionMark}>?</span>
                  ...
                  <div className={styles.shippingSection}>
                    ...
                    <div className={styles.shippingOptions}>
                      <div
                        ...
                        onClick={() => setSelectedShipping("Shipping to")}
                      >
                        <div className={styles.optionLeft}>
                          <div className={selectedShipping === "Shipping to" ? styles.radioSelected : styles.radio} />
                          <div>
                      ...
                      <div
                        className={styles.paymentOption}
                        onClick={() => setSelectedShipping("Local Pickup")}
                      >
                        <div className={styles.optionLeft}>
                          <div className={selectedShipping === "Local Pickup" ? styles.radioSelected : styles.radio} />
...
//     if (storedWatch) {
//       const parsedWatch = JSON.parse(storedWatch);
//       console.log("Watch in product scre", parsedWatch);
//       setProductData(parsedWatch);
//       setQuestionId(parsedWatch?.id); // if needed for <Chat />
//     }
//   }, []);
